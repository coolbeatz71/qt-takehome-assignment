 ...
 * @property {React.ReactNode} footer - Modal footer content
 * @property {string} size - Modal size variant
 */
...
/**
 * Modal component with overlay and keyboard support
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          <div className="px-8 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">
            {children}
          </div>
